!(function (t) {
	...
	function (t, i, e) {
		'use strict';
		var r = { DEBUG_LOG: !1, DEBUG_MOUSE_LOG: !1, DEBUG_DRAW_HIT_AREA: !1, DEBUG_DRAW_ALPHA_MODEL: !1, VIEW_MAX_SCALE: 2, VIEW_MIN_SCALE: 0.8, VIEW_LOGICAL_LEFT: -1, VIEW_LOGICAL_RIGHT: 1, VIEW_LOGICAL_MAX_LEFT: -2, VIEW_LOGICAL_MAX_RIGHT: 2, VIEW_LOGICAL_MAX_BOTTOM: -2, VIEW_LOGICAL_MAX_TOP: 2, PRIORITY_NONE: 0, PRIORITY_IDLE: 1, PRIORITY_SLEEPY: 2, PRIORITY_NORMAL: 3, PRIORITY_FORCE: 4, MOTION_GROUP_IDLE: 'idle', MOTION_GROUP_SLEEPY: 'sleepy', MOTION_GROUP_TAP_BODY: 'tap_body', MOTION_GROUP_FLICK_HEAD: 'flick_head', MOTION_GROUP_PINCH_IN: 'pinch_in', MOTION_GROUP_PINCH_OUT: 'pinch_out', MOTION_GROUP_SHAKE: 'shake', HIT_AREA_HEAD: 'head', HIT_AREA_BODY: 'body' };
		t.exports = r;
	},
	function (t, i, e) {
		'use strict';
		...
		(function (t) {
			!(function () {
							...
							for (var h = i.length, l = t.width, $ = t.height, u = this.context, p = this._$xP, f = this._$uP, c = this._$6r, d = this._$3r, g = nt.tr, y = nt._$Ti, m = nt._$Pi, T = nt._$B, P = 0; P < h; P += 3) {
								...
								if ((n || (n = 1.2), at.IGNORE_EXPAND && (n = 0), at.USE_CACHED_POLYGON_IMAGE)) {
									...
									if (((it.gl_cacheImage = it.gl_cacheImage || {}), !it.gl_cacheImage[P])) {
										...
										rt.translate(-Q, -Z), nt.clip(rt, g, n, Y, O, D, R, b, F, C, M, E, A, I, w, x), rt.drawImage(t, 0, 0), (it.gl_cacheImage[P] = { cacheCanvas: et, cacheContext: rt });
									}
				...
				(at._$yr = !1),
					...
					(at.DEBUG_DATA = {}),
					(at.PROFILE_IOS_SPEED = { PROFILE_NAME: 'iOS Speed', USE_ADJUST_TRANSLATION: !0, USE_CACHED_POLYGON_IMAGE: !0, EXPAND_W: 4 }),
					(at.PROFILE_IOS_QUALITY = { PROFILE_NAME: 'iOS HiQ', USE_ADJUST_TRANSLATION: !0, USE_CACHED_POLYGON_IMAGE: !1, EXPAND_W: 2 }),
					(at.PROFILE_IOS_DEFAULT = at.PROFILE_IOS_QUALITY),
					(at.PROFILE_ANDROID = { PROFILE_NAME: 'Android', USE_ADJUST_TRANSLATION: !1, USE_CACHED_POLYGON_IMAGE: !1, EXPAND_W: 2 }),
					(at.PROFILE_DESKTOP = { PROFILE_NAME: 'Desktop', USE_ADJUST_TRANSLATION: !1, USE_CACHED_POLYGON_IMAGE: !1, EXPAND_W: 2 }),
